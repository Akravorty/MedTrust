...
def _mock_batches() -> Dict[str, Batch]:
    ...
    hold_batch = Batch(
        ...
        ocr_extracted_text="AMOXICILLIN 500MG BATCH AMX-2026-0417 MFG 2026-01-10 EXP 2027-01-10",
    ...
    accept_batch = Batch(
        ...
        ocr_extracted_text="PARACETAMOL 650MG BATCH PCM-2026-0912 MFG 2026-02-01 EXP 2028-02-01",
...
def _mock_decisions() -> Dict[str, RiskDecision]:
    hold_decision = RiskDecision(
        ...
        shap_contributors=[
            {"feature": "storage_temp_log.max_excursion_c", "value": 12.8, "contribution": 0.41},
            {"feature": "supplier.reject_rate_3mo", "value": 0.14, "contribution": 0.22},
            {"feature": "physical_inspection.damage_flag", "value": 1, "contribution": 0.09},
        ],
        reasons=[
    ...
    accept_decision = RiskDecision(
        ...
        triggered_rule="NONE",
        shap_contributors=[
            {"feature": "storage_temp_log.max_excursion_c", "value": 5.0, "contribution": 0.02},
            {"feature": "supplier.reject_rate_3mo", "value": 0.02, "contribution": 0.01},
        ],
